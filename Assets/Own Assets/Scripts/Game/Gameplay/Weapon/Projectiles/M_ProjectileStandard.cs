...
namespace Game.Gameplay.Weapons.Projectiles
{
    public class M_ProjectileStandard : M_ProjectileBase
    {
        ...
        void OnEnable()
        {
            ...
            m_ProjectileBase.E_Onshoot.AddListener(OnShoot);
        ...
        private void OnShoot()
        {
            ...
            M_PlayerWeaponsManager playerWeaponsManager = m_ProjectileBase.Owner.GetComponent<M_PlayerWeaponsManager>();
        ...
        bool IsHitValid(RaycastHit hit)
        {
            ...
            if (hit.collider.isTrigger && hit.collider.GetComponent<M_Damageable>() == null)
            {
                return false;
            }
